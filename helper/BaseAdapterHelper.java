 ...
 */
package com.jqielts.through.theworld.adapter.helper;
...
public class BaseAdapterHelper {
    ...
    /**
     * Will set the time of a TextView.
     *
     * @param viewId The view id.
     * @param value  The text to put in the text view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTime(int viewId, String value) {
        TextView view = retrieveView(viewId);
        String time = TimeUtils.getIntance().getTime(value);
        view.setText(time);
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageUrl(Context context, int viewId, String imageUrl, int drawable) {
        ImageView view = retrieveView(viewId);
    ...
    public BaseAdapterHelper setParams(int viewId, RelativeLayout.LayoutParams params) {
        ImageView view = retrieveView(viewId);
        view.setLayoutParams(params);
        return this;
    }

    public BaseAdapterHelper setParams(int viewId, LinearLayout.LayoutParams params) {
        ImageView view = retrieveView(viewId);
        view.setLayoutParams(params);
        return this;
    }
    ...
    /**
     * Will download an image from a File and put it in an ImageView.<br/>
     * Picasso manages recycling of views in a ListView.<br/>
     * If you need more control over the Picasso settings, use {BaseAdapterHelper#setImageBuilder}.
     *
     * @param viewId The view id.
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageFile(Context context, int viewId, String path) {
        ImageView view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageCircle(Context context, int viewId, String path, int drawable, int size) {
        ImageView view = retrieveView(viewId);
//        GlideUtil.getInstance(context).setImageCircle(view, path, drawable, size);
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextWatcher(int viewId, TextWatcher listener) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setSelected(int viewId, boolean checked) {
    ...
    /**
     * Will set the hint of a TextView.
     *
     * @param viewId The view id.
     * @param value  The text to put in the text view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setHint(int viewId, String value) {
        TextView view = retrieveView(viewId);
        view.setHint(value);
        return this;
    }
